...
from ycappuccino_service_comm.bundles.remote_client import connect
from ycappuccino_service_comm_storage.api import IRemoteManager
...
class RemoteClientFactory(IRemoteClientFactory, IService):
    ...
    def create_remote_client(self, a_remote_server):
        with use_ipopo(self._context) as ipopo:
            ...
            if connect(a_remote_server.get_scheme(), a_remote_server.get_host(), a_remote_server.get_port()) is not None:
